...
enum BlockType
{
	GRASS = 0, STONE = 1, DIRT = 2, SAND = 3, WATER = 4
};
...
public:
	...
	GLfloat* GetGrassBlockVertsWithOffset(glm::vec3 offset, glm::vec2 _textureOffset)
	{
		GLfloat blockOffsetVertices[192] =
		{
			//COORDINATES													RGB     TEXTURE OFFSETS					 TEXTURE COORDINATES
	...
	GLfloat* GetBlockVertsWithOffset(glm::vec3 offset, glm::vec2 _textureOffset, BlockType _type)
	{
		...
		{ 
			return GetGrassBlockVertsWithOffset(offset, _textureOffset);	
		}
		else {
